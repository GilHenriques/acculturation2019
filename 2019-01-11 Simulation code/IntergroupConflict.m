...
for repl = 1:1
    ...
    gamma = 0.01; 			% game rate proportionality constant
    ...
    parameters = ["maxG","G0","pBins","mu","sigma","sigmaR","x0","y0","p0","q0","r0","bM","bD","bS","dX","dY","dt","T","tout","delta","gamma","epsilon","phi","Fs","Gs","Gtot","Etot","Ftot"];
    parameters2 = [maxG,  G0,  pBins,  mu,  sigma,  sigmaR,  x0,  y0,  p0,  q0,  r0,  bM,  bD,  bS,  dX,  dY,  dt,  T,  tout,  delta,  gamma,  epsilon,  phi,  Fs,  Gs,  Gtot,  Etot,  Ftot];
